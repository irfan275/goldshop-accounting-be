...
var adjustment_ledger_route = require('./src/route/adjustment_ledger');
var buyAndSell_ledger_route = require('./src/route/buyAndSell_ledger');
var silver_buyAndSell_route = require('./src/route/silverBuyAndSell');
...
app.use(basePath+'/adjustmentLedger', adjustment_ledger_route);
app.use(basePath+'/gold/buyAndSellLedger', buyAndSell_ledger_route);
app.use(basePath+'/silver/buyAndSellLedger', silver_buyAndSell_route);
