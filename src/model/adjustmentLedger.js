...
const AdjustmentLedgerSchema = new Schema({
    invoiceNumber: {
        type: String,
        unique: true,
    },
...
}, { collection: 'AdjustmentLedger',timestamps: true });
AdjustmentLedgerSchema.pre("save", async function (next) {
  try {
...
const AdjustmentLedger = mongoose.model("AdjustmentLedger", AdjustmentLedgerSchema);
module.exports = AdjustmentLedger;